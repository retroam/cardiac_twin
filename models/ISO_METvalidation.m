...
% end
% 
% figure;semilogx(METrange*1e-6,cAMP);hold all;
...
% figure;semilogx(METrange*1e-6,cAMP);hold all;
% figure;semilogx(METrange*1e-6,calcium);
save ISOMET_cAMP cAMP;
save ISOMET_Ca ISOMET_Ca;
