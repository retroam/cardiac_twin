...
def dae_ode(t: float, y: np.ndarray, params: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """Signaling-only ODE right-hand side converted from MATLAB."""
